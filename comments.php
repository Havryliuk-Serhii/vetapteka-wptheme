<div class="comments">
			<?php if ( post_password_required() ) : ?>
				<p class="nopassword"><?php _e( 'Цей пост захищено паролем. Введіть пароль щобподивитися коментарі.', 'vetapteka' ); ?></p>
...
<div class="comments-form">
	<?php 
		$comments_args = array(
					...
					'submit_field'         => '<div class="comments-form"><h3 class="text-center">%1$s</h3></div>',					
		);
